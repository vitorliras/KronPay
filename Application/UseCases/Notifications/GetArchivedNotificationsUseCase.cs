...
public sealed class GetArchivedNotificationsUseCase
    : IUseCaseWithoutRequest<IReadOnlyList<NotificationResponse>>
{
    private readonly INotificationRepository _repository;
    private readonly ICurrentUserService _currentUser;

    public GetArchivedNotificationsUseCase(
    ...
    {
        var notifications = await _repository.GetArchivedByUserAsync(_currentUser.UserId);
