...
public sealed class ChangeStatusTransactionRangeUseCase
    : IUseCase<ChangeStatusTransactionRangeRequest, TransactionRangeResponse>
{
    ...
    public ChangeStatusTransactionRangeUseCase(ITransactionRepository transactionRepository, IUnitOfWork uow, ICurrentUserService currentUser)
    {
    ...
    public async Task<ResultEntity<TransactionRangeResponse>> ExecuteAsync(ChangeStatusTransactionRangeRequest requests)
    {
